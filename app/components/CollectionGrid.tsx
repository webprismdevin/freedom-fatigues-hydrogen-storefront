export function CollectionGrid() {
  return (
    <div className="grid min-h-[400px] grid-cols-4 gap-4 p-4">
      <div className="relative grid place-items-center font-heading text-2xl uppercase">
        <img
          className="absolute left-0 top-0 z-0 h-full w-full object-cover object-center opacity-80"
          src={
